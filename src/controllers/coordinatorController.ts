...
export default {
  ...
  getPendingRescheduleRequestsController: getPendingRescheduleRequestsControllerFn,

  approveRescheduleRequestController: approveRescheduleRequestControllerFn,

  rejectRescheduleRequestController: rejectRescheduleRequestControllerFn,
